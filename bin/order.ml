...
let print_order_graph (buy_orders: order list) (sell_orders: order list) =
  ...
  let max_rate_b = List.fold_left (fun acc order -> max acc ((int_of_float (order.rate *. 100.))/5)) 0 buy_orders in
  ...
  let grid = Array.make_matrix (max_rate+1) (20 ) "   " in

  (* Iterate over the orders and fill in the grid with '*' characters at the corresponding coordinates *)
  List.iter (fun order ->
  ...
  List.iter (fun order ->
    for x = 0 to min 20 order.amount/5 do
      if x < 20 then
  ...
  (*let orders = {
    buy_orders = [
    { user = "Alice";rate = 10; amount = 10 };
    { user = "Bob"; rate = 10; amount = 15 };
    { user = "Alice";  rate = 30; amount = 20 };
    { user = "Charlie"; rate = 40; amount = 10 };
    { user = "Alice";rate = 40; amount = 20 };
    { user = "Bob"; rate = 45; amount = 35 };
    { user = "Alice";  rate = 47; amount = 40 };
    { user = "Charlie"; rate = 50; amount = 50 };
    { user = "Alice";rate = 51; amount = 70 };
    { user = "Bob"; rate = 10; amount = 75 };
    { user = "Alice";  rate = 20; amount = 80 };
    { user = "Charlie"; rate = 00; amount = 50 }
  ];
sell_orders = [
    { user = "Alice";rate = 60; amount = 10 };
    { user = "Bob"; rate = 65; amount = 15 };
    { user = "Alice";  rate = 70; amount = 20 };
    { user = "Charlie"; rate = 80; amount = 10 };
    { user = "Alice";rate = 90; amount = 20 };
    { user = "Bob"; rate = 95; amount = 35 };
    { user = "Alice";  rate = 100.; amount = 40 };
    { user = "Alice";  rate = 70; amount = 40 }
  ]
  }*)
